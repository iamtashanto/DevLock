      ...
      <header className="fixed top-0 z-50 w-full border-b border-white/5 bg-slate-950/80 backdrop-blur-xl">
        <nav className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8" aria-label="Main navigation">
          ...
          <div className="hidden items-center gap-8 md:flex">
            ...
            <a href="/docs" className="text-sm text-slate-300 transition hover:text-white">Docs</a>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-5">
            ...
            <div>
              ...
              <ul className="mt-4 space-y-3">
                <li><a href="/docs" className="text-sm text-slate-400 transition hover:text-white">Documentation</a></li>
                <li><a href="/docs#backend-sdk" className="text-sm text-slate-400 transition hover:text-white">API Reference</a></li>
